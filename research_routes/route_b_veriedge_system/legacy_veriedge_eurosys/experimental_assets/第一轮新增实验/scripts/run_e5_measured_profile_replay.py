...
def _run_policy_for_workload(
    ...
    expected_challenge_workload_sum = 0.0
    utility_sum = 0.0
    width_sum = 0.0
    ...
    for task in workload["tasks"]:
        ...
        expected_challenge_workload_ms = float(placement["verification_risk"]) * (
            float(placement["reference_replay_runtime_ms"]) + float(placement["challenge_latency_ms"])
        )
        ...
        expected_challenge_workload_sum += expected_challenge_workload_ms
        ...
        per_task.append(
            {
                ...
                "expected_challenge_workload_ms": round(expected_challenge_workload_ms, 6),
    ...
    summary = {
        ...
        "expected_challenge_workload_ms_per_task": round(expected_challenge_workload_sum / task_count, 6),
    ...
    _write_csv(
        ...
        [
            ...
            "feasible_under_alpha_beta",
                "verifier_workload_ms",
                "expected_challenge_workload_ms",
                "completion_utility",
        ],
    )
    _write_csv(
